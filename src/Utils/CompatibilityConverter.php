...
namespace ReportingAuthorizationSummaryApiLib\Utils;
...
use ReportingAuthorizationSummaryApiLib\Exceptions\ApiException;
use ReportingAuthorizationSummaryApiLib\Http\ApiResponse;
use ReportingAuthorizationSummaryApiLib\Http\HttpContext;
use ReportingAuthorizationSummaryApiLib\Http\HttpRequest;
use ReportingAuthorizationSummaryApiLib\Http\HttpResponse;
