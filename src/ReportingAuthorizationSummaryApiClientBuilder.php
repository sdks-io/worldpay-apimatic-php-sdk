...
class ReportingAuthorizationSummaryApiClientBuilder
{
    /**
     * @var array
     */
    ...
    public function build(): ReportingAuthorizationSummaryApiClient
    {
        return new ReportingAuthorizationSummaryApiClient($this->config);
    }
}
