...
The following example uses `Monolog\Logger` implementation of `Psr\Log\LoggerInterface` for ReportingAuthorizationSummaryApiClient initialization.
...
$logger = new Logger('ReportingAuthorizationSummaryApi');
