...
# Authorizations Summary Cardnetwork Response
...
| `summaries` | [`?(Summary[])`](../../doc/models/summary.md) | Optional | Summary | getSummaries(): ?array | setSummaries(?array summaries): void |
| `additionalProperties` | `array<string, array>` | Optional | - | findAdditionalProperty(string key): array | additionalProperty(string key, array value): void |

## Example

```php
use ReportingAuthorizationSummaryApiLib\Models\Builders\AuthorizationsSummaryCardnetworkResponseBuilder;
...
$authorizationsSummaryCardnetworkResponse = AuthorizationsSummaryCardnetworkResponseBuilder::init()
    ->pagination(
