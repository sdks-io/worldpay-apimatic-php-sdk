...
| `summaries` | [`?(Summary4[])`](../../doc/models/summary-4.md) | Optional | Capturing the fields. | getSummaries(): ?array | setSummaries(?array summaries): void |
| `additionalProperties` | `array<string, array>` | Optional | - | findAdditionalProperty(string key): array | additionalProperty(string key, array value): void |

## Example

```php
use ReportingAuthorizationSummaryApiLib\Models\Builders\SummaryDetailMerchantBuilder;
...
$summaryDetailMerchant = SummaryDetailMerchantBuilder::init()
    ->pagination(
