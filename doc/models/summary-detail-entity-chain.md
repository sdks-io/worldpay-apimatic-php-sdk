...
```php
use ReportingAuthorizationSummaryApiLib\Models\Builders\SummaryDetailEntityChainBuilder;
use ReportingAuthorizationSummaryApiLib\ApiHelper;

$summaryDetailEntityChain = SummaryDetailEntityChainBuilder::init()
    ->chainCode('1X0010')
