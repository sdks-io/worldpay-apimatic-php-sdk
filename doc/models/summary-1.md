...
| `transactionDate` | `?string` | Optional | The transaction date is the specific day when a financial transaction, such as a purchase or sale, takes place officially.<br><br>**Constraints**: *Minimum Length*: `10`, *Maximum Length*: `10`, *Pattern*: `^[0-9]{4}-[0-9]{2}-[0-9]{2}$` | getTransactionDate(): ?string | setTransactionDate(?string transactionDate): void |
| `additionalProperties` | `array<string, array>` | Optional | - | findAdditionalProperty(string key): array | additionalProperty(string key, array value): void |

## Example

```php
use ReportingAuthorizationSummaryApiLib\Models\Builders\Summary1Builder;
use ReportingAuthorizationSummaryApiLib\ApiHelper;

$summary1 = Summary1Builder::init()
    ->approvedCount(10)
