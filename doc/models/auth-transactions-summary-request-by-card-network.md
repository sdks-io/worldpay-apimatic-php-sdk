...
```php
use ReportingAuthorizationSummaryApiLib\Models\Builders\AuthTransactionsSummaryRequestByCardNetworkBuilder;
...
$authTransactionsSummaryRequestByCardNetwork = AuthTransactionsSummaryRequestByCardNetworkBuilder::init(
    EntityBuilder::init()
