...
```php
use ReportingAuthorizationSummaryApiLib\Models\Builders\AuthTransactionsSummaryRequestByMerchantBuilder;
...
$authTransactionsSummaryRequestByMerchant = AuthTransactionsSummaryRequestByMerchantBuilder::init(
    EntityBuilder::init()
