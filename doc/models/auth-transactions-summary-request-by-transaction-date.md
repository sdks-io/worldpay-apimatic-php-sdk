...
```php
use ReportingAuthorizationSummaryApiLib\Models\Builders\AuthTransactionsSummaryRequestByTransactionDateBuilder;
...
$authTransactionsSummaryRequestByTransactionDate = AuthTransactionsSummaryRequestByTransactionDateBuilder::init(
    EntityBuilder::init()
