...
| `cardType` | `?string` | Optional | The category or classification of a payment card based on the issuing network.<br><br>**Constraints**: *Minimum Length*: `0`, *Maximum Length*: `255` | getCardType(): ?string | setCardType(?string cardType): void |
| `cardNetwork` | [`?CodeAndDescription`](../../doc/models/code-and-description.md) | Optional | - | getCardNetwork(): ?CodeAndDescription | setCardNetwork(?CodeAndDescription cardNetwork): void |
| `additionalProperties` | `array<string, array>` | Optional | - | findAdditionalProperty(string key): array | additionalProperty(string key, array value): void |

## Example

```php
use ReportingAuthorizationSummaryApiLib\Models\Builders\SummaryBuilder;
