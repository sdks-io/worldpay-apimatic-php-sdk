...
| `summaries` | [`?(Summary6[])`](../../doc/models/summary-6.md) | Optional | Capturing the fields. | getSummaries(): ?array | setSummaries(?array summaries): void |
| `additionalProperties` | `array<string, array>` | Optional | - | findAdditionalProperty(string key): array | additionalProperty(string key, array value): void |

## Example

```php
use ReportingAuthorizationSummaryApiLib\Models\Builders\SummaryDetailSuperChainBuilder;
...
$summaryDetailSuperChain = SummaryDetailSuperChainBuilder::init()
    ->pagination(
