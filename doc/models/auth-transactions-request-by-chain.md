...
```php
use ReportingAuthorizationSummaryApiLib\Models\Builders\AuthTransactionsRequestByChainBuilder;
...
$authTransactionsRequestByChain = AuthTransactionsRequestByChainBuilder::init(
    EntityBuilder::init()
