...
```php
use ReportingAuthorizationSummaryApiLib\Models\Builders\AuthTransactionsRequestBySuperChainBuilder;
...
$authTransactionsRequestBySuperChain = AuthTransactionsRequestBySuperChainBuilder::init(
    EntityBuilder::init()
