...
```php
use ReportingAuthorizationSummaryApiLib\Models\Builders\AuthTransactionsRequestByDivisionBuilder;
...
$authTransactionsRequestByDivision = AuthTransactionsRequestByDivisionBuilder::init(
    EntityBuilder::init()
